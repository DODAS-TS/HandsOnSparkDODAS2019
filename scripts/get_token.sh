...
IAM_DEVICE_CODE_ENDPOINT=https://iam-demo.cloud.cnaf.infn.it/devicecode
...
IAM_TOKEN_ENDPOINT=https://iam-demo.cloud.cnaf.infn.it/token
...
while true; do
  ...
  sed -e "s/token_template/${access_token}/" $HOME/.dodas_template.yaml > $HOME/.dodas.yaml
